...
public class BlockAetherPortal extends BlockBreakable
{
    ...
    {
        BlockAetherPortal.Size blockportal$size = new BlockAetherPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
            BlockAetherPortal.Size blockportal$size1 = new BlockAetherPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        if (enumfacing$axis == EnumFacing.Axis.X)
        {
            BlockAetherPortal.Size blockportal$size = new BlockAetherPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            BlockAetherPortal.Size blockportal$size1 = new BlockAetherPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            ...
            // Spawning particles - now disabled
    ...
    public BlockPattern.PatternHelper func_181089_f(World world, BlockPos pos)
    {
        ...
        BlockAetherPortal.Size blockportal$size = new BlockAetherPortal.Size(world, pos, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.func_loadingcache(world, true);

        if (!blockportal$size.func_150860_b())
        {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new BlockAetherPortal.Size(world, pos, EnumFacing.Axis.Z);
        }
    ...
    public static class Size
    {
        ...
        protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
        {
            ...
            for (i = 0; i < 22; ++i)
            {
                ...
                if (!this.func_150857_a(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != Blocks.glowstone)
                {
                    break;
                }
            }
        ...
        protected int func_150858_a()
        {
            ...
            {
                if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, j).up(this.field_150862_g)).getBlock() != Blocks.glowstone)
                {
        ...
        public void func_150859_c()
        {
            for (int i = 0; i < this.field_150868_h; ++i)
            {
                ...
                {
                    this.world.setBlockState(blockpos.up(j), Blocks.aether_portal.getDefaultState().withProperty(BlockAetherPortal.AXIS, this.axis), 2);
                }
            }
        }
    }
