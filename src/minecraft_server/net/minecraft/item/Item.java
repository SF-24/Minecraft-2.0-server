...
//        registerItemBlock(Blocks.gravitite_ore);
        ...
        registerItem(valueBase + 260, "apple", (new ItemFood(4, 0.3F, false)).setUnlocalizedName("apple"));
        ...
        registerItem(valueBase + 297, "bread", (new ItemFood(5, 0.6F, false)).setUnlocalizedName("bread"));
        // Missing armour
        registerItem(valueBase + 318, "flint", (new Item()).setUnlocalizedName("flint").setCreativeTab(CreativeTabs.tabMaterials));
        registerItem(valueBase + 319, "porkchop", (new ItemFood(3, 0.3F, true)).setUnlocalizedName("porkchopRaw"));
        registerItem(valueBase + 320, "cooked_porkchop", (new ItemFood(8, 0.8F, true)).setUnlocalizedName("porkchopCooked"));
        registerItem(valueBase + 321, "painting", (new ItemHangingEntity(EntityPainting.class)).setUnlocalizedName("painting"));
        registerItem(valueBase + 322, "golden_apple", (new ItemAppleGold(4, 1.2F, false)).setAlwaysEdible(true).setPotionEffect(Potion.regeneration.id, 5, 1, 1.0F).setUnlocalizedName("appleGold"));
        ...
        registerItem(valueBase + 357, "cookie", (new ItemFood(2, 0.1F, false)).setUnlocalizedName("cookie"));
        registerItem(valueBase + 358, "filled_map", (new ItemMap()).setUnlocalizedName("map"));
        registerItem(valueBase + 360, "melon", (new ItemFood(2, 0.3F, false)).setUnlocalizedName("melon"));
        ...
        registerItem(valueBase + 363, "beef", (new ItemFood(3, 0.3F, true)).setUnlocalizedName("beefRaw"));
        registerItem(valueBase + 364, "cooked_beef", (new ItemFood(8, 0.8F, true)).setUnlocalizedName("beefCooked"));
        registerItem(valueBase + 365, "chicken", (new ItemFood(2, 0.3F, true)).setPotionEffect(Potion.hunger.id, 30, 0, 0.3F).setUnlocalizedName("chickenRaw"));
        registerItem(valueBase + 366, "cooked_chicken", (new ItemFood(6, 0.6F, true)).setUnlocalizedName("chickenCooked"));
        registerItem(valueBase + 367, "rotten_flesh", (new ItemFood(4, 0.1F, true)).setPotionEffect(Potion.hunger.id, 30, 0, 0.8F).setUnlocalizedName("rottenFlesh"));
        ...
        registerItem(valueBase + 375, "spider_eye", (new ItemFood(2, 0.8F, false)).setPotionEffect(Potion.poison.id, 5, 0, 1.0F).setUnlocalizedName("spiderEye").setPotionEffect(PotionHelper.spiderEyeEffect));
        ...
        registerItem(valueBase + 393, "baked_potato", (new ItemFood(5, 0.6F, false)).setUnlocalizedName("potatoBaked"));
        registerItem(valueBase + 394, "poisonous_potato", (new ItemFood(2, 0.3F, false)).setPotionEffect(Potion.poison.id, 5, 0, 0.6F).setUnlocalizedName("potatoPoisonous"));
        registerItem(valueBase + 395, "map", (new ItemEmptyMap()).setUnlocalizedName("emptyMap"));
        registerItem(valueBase + 396, "golden_carrot", (new ItemFood(6, 1.2F, false)).setUnlocalizedName("carrotGolden").setPotionEffect(PotionHelper.goldenCarrotEffect).setCreativeTab(CreativeTabs.tabBrewing));
        ...
        registerItem(valueBase + 400, "pumpkin_pie", (new ItemFood(8, 0.3F, false)).setUnlocalizedName("pumpkinPie").setCreativeTab(CreativeTabs.tabFood));
        ...
        registerItem(valueBase + 411, "rabbit", (new ItemFood(3, 0.3F, true)).setUnlocalizedName("rabbitRaw"));
        registerItem(valueBase + 412, "cooked_rabbit", (new ItemFood(5, 0.6F, true)).setUnlocalizedName("rabbitCooked"));
        ...
        registerItem(valueBase + 423, "mutton", (new ItemFood(2, 0.3F, true)).setUnlocalizedName("muttonRaw"));
        registerItem(valueBase + 424, "cooked_mutton", (new ItemFood(6, 0.8F, true)).setUnlocalizedName("muttonCooked"));
...
//        registerItem(valueBase+5011, "cave_map", (new ItemEmptyMap()).setUnlocalizedName("emptyCaveMap"));
    ...
    public static void updateFoodStackCount(int value, EnumFoodStackType foodStackType)
    {
        for (Item item : itemRegistry)
        {
            if (item != null)
            {
                item.setFoodStackCount(value, foodStackType);
            }
        }
    }
