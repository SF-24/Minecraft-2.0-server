...
public class WorldGenCanopyTreeJungle extends WorldGenAbstractTree
{
    private static final IBlockState logBlock = Blocks.log.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK);
    private static final IBlockState leaves = Blocks.leaves.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.JUNGLE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenCanopyTreeJungle(boolean p_i45461_1_)
    {
        super(p_i45461_1_);
    }
