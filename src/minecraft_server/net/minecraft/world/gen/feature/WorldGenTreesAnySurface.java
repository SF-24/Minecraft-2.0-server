...
public class WorldGenTreesAnySurface extends WorldGenAbstractTree
{
    ...
    private final boolean allowStone;
    ...
    public WorldGenTreesAnySurface(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, field_181653_a, field_181654_b, false, false);
    }

    public WorldGenTreesAnySurface(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_, boolean p_i46446_5_, boolean allowStone)
    {
        super(p_i46446_1_);
