...
import net.minecraft.world.gen.feature.WorldGenAetherDungeons;
    ...
    public void func_180519_a(ChunkPrimer p_180519_1_)
    {
        for (int i = 0; i < 16; ++i)
        {
            for (int j = 0; j < 16; ++j)
            {
                int k = 1;
                int l = -1;
                IBlockState iblockstate = Blocks.grass.getDefaultState(); // Top block
                IBlockState iblockstate1 = Blocks.dirt.getDefaultState(); // Filler block
