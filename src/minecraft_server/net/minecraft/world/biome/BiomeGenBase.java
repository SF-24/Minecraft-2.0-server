...
public abstract class BiomeGenBase
{
    ...
    protected static final BiomeGenBase.Height height_HighHills = new BiomeGenBase.Height(1.2F, 0.5F);
    ...
    public static final BiomeGenBase volcanic_wasteland = (new BiomeGenWasteland(42)).setColor(12431967).setBiomeName("Volcanic Wasteland").setFillerBlockMetadata(12431967).setHeight(height_LowHills).setTemperatureRainfall(1.0F, 0.0F);
    public static final BiomeGenBase stoneMountains = (new BiomeGenMountains(43, true)).setColor(6316128).setBiomeName("Snowy Mountains").setHeight(height_HighHills).setTemperatureRainfall(0.2F, 0.3F);
    ...
    public static final BiomeGenBase autumnalForest = (new BiomeGenForestAutumnal(45, 0)).setColor(14274157).setBiomeName("Autumnal Forest");
