...
public abstract class BiomeGenBase
{
    ...
    protected static final BiomeGenBase.Height height_Default = new BiomeGenBase.Height(0.1F, 0.3F); // was 0.2
    protected static final BiomeGenBase.Height height_ShallowWaters = new BiomeGenBase.Height(-0.5F, 0.0F);
    protected static final BiomeGenBase.Height height_Oceans = new BiomeGenBase.Height(-1.0F, 0.2F /*from 0.1*/);
    ...
    public static final BiomeGenBase ocean = (new BiomeGenOcean(0)).setColor(112).setBiomeName("Ocean").setHeight(height_Oceans).setOcean();
    public static final BiomeGenBase plains = (new BiomeGenPlains(1)).setColor(9286496).setBiomeName("Plains");
    public static final BiomeGenBase desert = (new BiomeGenDesert(2)).setColor(16421912).setBiomeName("Desert").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setHeight(height_Desert).setClimateZone(ClimateZone.DESERT);
    ...
    public static final BiomeGenBase taiga = (new BiomeGenTaiga(5, 0)).setColor(747097).setBiomeName("Taiga").setFillerBlockMetadata(5159473).setTemperatureRainfall(0.25F, 0.8F).setHeight(height_MidPlains).setClimateZone(ClimateZone.COLD);
    ...
    public static final BiomeGenBase hell = (new BiomeGenHell(8)).setColor(16711680).setBiomeName("Hell").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setClimateZone(ClimateZone.NETHER);

    /** Is the biome used for sky world. */
    public static final BiomeGenBase sky = (new BiomeGenEnd(9)).setColor(8421631).setBiomeName("The End").setDisableRain().setClimateZone(ClimateZone.END);
    ...
    public static final BiomeGenBase mushroomIsland = (new BiomeGenMushroomIsland(14)).setColor(16711935).setBiomeName("MushroomIsland").setTemperatureRainfall(0.9F, 1.0F).setHeight(height_LowIslands).setClimateZone(ClimateZone.MUSHROOM_ISLAND);
    public static final BiomeGenBase mushroomIslandShore = (new BiomeGenMushroomIsland(15)).setColor(10486015).setBiomeName("MushroomIslandShore").setTemperatureRainfall(0.9F, 1.0F).setHeight(height_Shores).setClimateZone(ClimateZone.MUSHROOM_ISLAND);

    /** Beach biome. */
    public static final BiomeGenBase beach = (new BiomeGenBeach(16, Blocks.sand.getDefaultState())).setColor(16440917).setBiomeName("Beach").setTemperatureRainfall(0.8F, 0.4F).setHeight(height_Shores).setClimateZone(ClimateZone.WARM);

    /** Desert Hills biome. */
    public static final BiomeGenBase desertHills = (new BiomeGenDesert(17)).setColor(13786898).setBiomeName("DesertHills").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setHeight(height_LowHills).setClimateZone(ClimateZone.DESERT);
    ...
    /** Taiga Hills biome. */
    public static final BiomeGenBase taigaHills = (new BiomeGenTaiga(19, 0)).setColor(1456435).setBiomeName("TaigaHills").setFillerBlockMetadata(5159473).setTemperatureRainfall(0.25F, 0.8F).setHeight(height_LowHills).setClimateZone(ClimateZone.COLD);
    ...
    public static final BiomeGenBase jungle = (new BiomeGenJungle(21, false)).setColor(5470985).setBiomeName("Jungle").setFillerBlockMetadata(5470985).setTemperatureRainfall(0.95F, 0.9F).setHeight(height_Jungle).setClimateZone(ClimateZone.JUNGLE);
    public static final BiomeGenBase jungleHills = (new BiomeGenJungle(22, false)).setColor(2900485).setBiomeName("JungleHills").setFillerBlockMetadata(5470985).setTemperatureRainfall(0.95F, 0.9F).setHeight(height_JungleHills).setClimateZone(ClimateZone.JUNGLE);
    public static final BiomeGenBase jungleEdge = (new BiomeGenJungle(23, true)).setColor(6458135).setBiomeName("JungleEdge").setFillerBlockMetadata(5470985).setTemperatureRainfall(0.95F, 0.8F).setClimateZone(ClimateZone.JUNGLE);
    ...
    public static final BiomeGenBase megaTaiga = (new BiomeGenTaiga(32, 1)).setColor(5858897).setBiomeName("Mega Taiga").setFillerBlockMetadata(5159473).setTemperatureRainfall(0.3F, 0.8F).setHeight(height_MidPlains).setClimateZone(ClimateZone.COLD);
    public static final BiomeGenBase megaTaigaHills = (new BiomeGenTaiga(33, 1)).setColor(4542270).setBiomeName("Mega Taiga Hills").setFillerBlockMetadata(5159473).setTemperatureRainfall(0.3F, 0.8F).setHeight(height_LowHills).setClimateZone(ClimateZone.COLD);
    public static final BiomeGenBase extremeHillsPlus = (new BiomeGenHills(34, true)).setColor(5271632).setBiomeName("Extreme Hills+").setHeight(height_MidHills).setTemperatureRainfall(0.2F, 0.3F).setClimateZone(ClimateZone.COLD);
    public static final BiomeGenBase savanna = (new BiomeGenSavanna(35)).setColor(12431967).setBiomeName("Savanna").setTemperatureRainfall(1.2F, 0.0F).setDisableRain().setHeight(height_LowPlains).setClimateZone(ClimateZone.WARM);
    public static final BiomeGenBase savannaPlateau = (new BiomeGenSavanna(36)).setColor(10984804).setBiomeName("Savanna Plateau").setTemperatureRainfall(1.0F, 0.0F).setDisableRain().setHeight(height_HighPlateaus).setClimateZone(ClimateZone.WARM);
    public static final BiomeGenBase mesa = (new BiomeGenMesa(37, false, false)).setColor(14238997).setBiomeName("Mesa").setHeight(height_Desert).setClimateZone(ClimateZone.RED_DESERT);
    public static final BiomeGenBase mesaPlateau_F = (new BiomeGenMesa(38, false, true)).setColor(11573093).setBiomeName("Mesa Plateau F").setHeight(height_HighPlateaus).setClimateZone(ClimateZone.RED_DESERT);
    public static final BiomeGenBase mesaPlateau = (new BiomeGenMesa(39, false, false)).setColor(13274213).setBiomeName("Mesa Plateau").setHeight(height_HighPlateaus).setClimateZone(ClimateZone.RED_DESERT);

    // New biomes

    /** Biome used for the aether */
    public static final BiomeGenBase aether = (new BiomeGenAether(40)).setColor(9474208).setBiomeName("The Aether").setDisableRain().setClimateZone(ClimateZone.AETHER);

    public static final BiomeGenBase tropical_swampland = (new BiomeGenSwampTropical(41)).setColor(5470985).setBiomeName("TropicalSwampland").setFillerBlockMetadata(5470985).setHeight(height_PartiallySubmerged).setTemperatureRainfall(0.95F, 0.9F).setClimateZone(ClimateZone.JUNGLE);

    public static final BiomeGenBase volcanic_wasteland = (new BiomeGenWasteland(42)).setColor(12431967).setBiomeName("VolcanicWasteland").setFillerBlockMetadata(12431967).setHeight(height_Wasteland).setTemperatureRainfall(1.0F, 0.0F).setClimateZone(ClimateZone.WASTELAND);
    ...
    public static final BiomeGenBase rainforest = (new BiomeGenJungleRainforest(44, false)).setColor(5470985).setBiomeName("Jungle Rainforest").setFillerBlockMetadata(5470985).setTemperatureRainfall(0.95F, 0.9F).setHeight(height_Autumnal).setClimateZone(ClimateZone.JUNGLE);
    ...
    protected ClimateZone climateZone = ClimateZone.TEMPERATE;
    ...
    protected BiomeGenBase setClimateZone(ClimateZone climateZone)
    {
    ...
    {
        this.climateZone=ClimateZone.SNOW;
    ...
    {
        this.climateZone=ClimateZone.OCEAN;
