...
public class BiomeGenForestAutumnal extends BiomeGenBase
{
    ...
    public BiomeGenForestAutumnal(int id, int p_i45377_2_)
    {
        super(id);
    ...
    protected BiomeGenBase createMutatedBiome(final int p_180277_1_)
    {
        ...
        {
            BiomeGenForestAutumnal biomegenforest = new BiomeGenForestAutumnal(p_180277_1_, 1);
        ...
        else
        {
            ...
            }: new BiomeGenMutated(p_180277_1_, this)
            {
                public WorldGenAbstractTree genBigTreeChance(Random rand)
                {
                    return rand.nextBoolean() ? BiomeGenForestAutumnal.field_150629_aC : BiomeGenForestAutumnal.field_150630_aD;
                }
            };
        }
    }
