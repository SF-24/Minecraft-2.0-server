...
public class BiomeAetherDecorator extends BiomeDecorator
{
    ...
    public void decorate(World worldIn, Random random, BiomeGenBase biome, BlockPos p_180292_4_)
    {
        ...
        else
        {
            ...
            //this.gravititeGen = new WorldGenMinable(Blocks.gravitite_ore.getDefaultState(), this.chunkProviderSettings.diamondSize);
            this.genDecorations(BiomeGenBase.aether);
    ...
    {
        this.genStandardOre1(4, this.ironGen, 1, 128);
        this.genStandardOre1(2, this.goldGen, 1, 128);
        this.genStandardOre1(1, this.coalGen, 1, 128);
    }
}
