...
public class BiomeGenMesaSnow extends BiomeGenBase
{
    ...
    public BiomeGenMesaSnow(int id, boolean p_i45380_2_, boolean p_i45380_3_)
    {
        super(id);
            ...
            else
            {
                ...
                else if (iblockstate1.getBlock() == Blocks.stone)
                {
                    if (l == -1)
                    {
                        ...
                        {
                            iblockstate = Blocks.packed_ice.getDefaultState();
                        ...
                        if (i1 < l1 - 1)
                        {
                            ...
                            if (iblockstate3.getBlock() == Blocks.packed_ice)
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, iblockstate3.getBlock().getDefaultState());
                            }
                        }
                        ...
                        else
                        {
                            ...
                            if (i1 >= 64 && i1 <= 127)
                            {
                                if (flag)
                                {
                                    iblockstate4 = Blocks.snow.getDefaultState();
                                }
                                else
                                {
                            ...
                            {
                                iblockstate4 = Blocks.packed_ice.getDefaultState();
                            }
                    ...
                    else if (l > 0)
                    {
                        ...
                        if (flag1)
                        {
                            chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.snow.getDefaultState());
                        }
                        else
                        {
    ...
    private void func_150619_a(long p_150619_1_)
    {
        ...
        Arrays.fill(this.field_150621_aC, Blocks.ice.getDefaultState());
        ...
        for (int l1 = 0; l1 < 64; ++l1)
        {
            ...
            if (l1 < 64)
            {
                this.field_150621_aC[l1] = Blocks.packed_ice.getDefaultState();
            }
        }
        ...
        for (int i = 0; i < i2; ++i)
        {
            ...
            {
                this.field_150621_aC[k + l] = Blocks.packed_ice.getDefaultState();
            }
        }
        ...
        for (int k2 = 0; k2 < j2; ++k2)
        {
            ...
            {
                this.field_150621_aC[l3 + i1] = Blocks.packed_ice.getDefaultState();
            }
        }
        ...
        for (int j3 = 0; j3 < l2; ++j3)
        {
            ...
            {
                this.field_150621_aC[k4 + j1] = Blocks.packed_ice.getDefaultState();
            }
        }
        ...
        for (int l4 = 0; l4 < k3; ++l4)
        {
            ...
            {
                this.field_150621_aC[j4 + k1] = Blocks.packed_ice.getDefaultState();

                if (j4 + k1 > 1 && random.nextBoolean())
                {
                    this.field_150621_aC[j4 + k1 - 1] = Blocks.snow.getDefaultState();
                }
    ...
    protected BiomeGenBase createMutatedBiome(int p_180277_1_)
    {
        ...
        BiomeGenMesaSnow biomegenmesa = new BiomeGenMesaSnow(p_180277_1_, flag, this.field_150620_aI);
