...
public class StructureNetherBridgePieces
{
    ...
    {
        static final int maxSize = NetherConfig.fortressWellRoomMaxSize; // was 12
        static final int midSize = maxSize/2;
        static int doorWidth = 5; // Widened by 1 block on each side (3 -> 5)
        static int halfDoor = doorWidth / 2; // Calculates half-width (5 / 2 = 2)

        public Entrance()
        {
        }

        public Entrance(int p_i45617_1_, Random p_i45617_2_, StructureBoundingBox boundingBoxIn, EnumFacing p_i45617_4_)
        {
            super(p_i45617_1_);
        ...
        // The entrance bounding box and configuration
        public static StructureNetherBridgePieces.Entrance func_175881_a(List<StructureComponent> structureComponents, Random random, int x, int y, int z, EnumFacing facing, int type)
        {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, /*X Offset, was -5*/ -(midSize-1), /*Y Offset*/ -3, 0, NetherConfig.fortressWellRoomMaxSize+1, 14, NetherConfig.fortressWellRoomMaxSize+1, facing);
            return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(structureComponents, structureboundingbox) == null ? new StructureNetherBridgePieces.Entrance(type, random, structureboundingbox, facing) : null;
        }

        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            // Floor platform and walls.
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 0, maxSize, 4, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, maxSize, 13, maxSize, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 1, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, maxSize-1, 5, 0, maxSize, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);

            // Entrance archways
            // Back wall
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 5, maxSize-1, midSize-5 /*was 2*/, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize+5 /*was 2*/, 5, maxSize-1, maxSize-2, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-5 /*was 1*/, 9, maxSize-1, midSize+5 /*was 1*/, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);

            // Pillar separating the 2 doorways
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-1, 5, maxSize-1, midSize+1, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
//            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-4, 9, maxSize-1, midSize+4, 12, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);

            // Front wall
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 5, 0, midSize-2, 12, 1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize+2, 5, 0, maxSize-2, 12, 1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-1, 9, 0, midSize+1, 12, 1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);

            // Roof platform with door and fence
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 11, 2, maxSize-2, 12, maxSize-2, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-1, 8, 0, midSize+1, 8, 0, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);

            // Iterator
            for (int i = 1; i <= maxSize-1; i += 2)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, 10, maxSize, i, 11, maxSize, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, maxSize, 10, i, 12, 11, i, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
                this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), i, 13, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), i, 13, maxSize, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), 0, 13, i, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), maxSize, 13, i, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), i + 1, 13, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), i + 1, 13, maxSize, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), 0, 13, i + 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), maxSize, 13, i + 1, structureBoundingBoxIn);
            }

            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), 0, 13, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), 0, 13, maxSize, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), 0, 13, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.nether_brick_fence.getDefaultState(), maxSize, 13, 0, structureBoundingBoxIn);

            // Windows
            for (int k = 3; k <= maxSize-3 /*?*/; k += 2)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, maxSize-1, 7, k, maxSize-1, 8, k, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
            }

            // Base cross foundation, todo: improve doorway.
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-2, 2, 0, midSize+2, 2, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 2, midSize-2, maxSize, 2, midSize+2, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-2, 0, 0, midSize+2, 1, 3, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-2, 0, 9, midSize+2, 1, maxSize, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, midSize-2, 3, 1, maxSize-4, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, maxSize-3, 0, midSize-2, maxSize, 1, maxSize-4, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);

            // Support Pillars
            for (int l = midSize-2; l <= midSize+2; ++l)
            {
                for (int j = 0; j <= 2; ++j)
                {
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.nether_brick.getDefaultState(), l, -1, j, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.nether_brick.getDefaultState(), l, -1, maxSize - j, structureBoundingBoxIn);
                }
            }

            for (int i1 = 0; i1 <= 2; ++i1)
            {
                for (int j1 = midSize-2; j1 <= midSize+2; ++j1)
                {
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.nether_brick.getDefaultState(), i1, -1, j1, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.nether_brick.getDefaultState(), maxSize - i1, -1, j1, structureBoundingBoxIn);
                }
            }

            // Centered lava well

            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize-1, 5, midSize-1, midSize+1, 5, midSize+1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, midSize, 1, midSize, midSize, 4, midSize, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            this.setBlockState(worldIn, Blocks.nether_brick.getDefaultState(), midSize, 0, midSize, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.flowing_lava.getDefaultState(), midSize, 5, midSize, structureBoundingBoxIn);

            BlockPos blockpos = new BlockPos(this.getXWithOffset(midSize, midSize), this.getYWithOffset(5), this.getZWithOffset(midSize, midSize));

            // Lava in the lava well
            if (structureBoundingBoxIn.isVecInside(blockpos))
            {
                worldIn.forceBlockUpdateTick(Blocks.flowing_lava, blockpos, randomIn);
            }

            if (structureBoundingBoxIn.isVecInside(this.getXWithOffset(midSize,midSize), this.getYWithOffset(4), this.getZWithOffset(midSize,midSize)))
            {
                // Spawner, just under the lava in the pool
                worldIn.setBlockPrimitive(this.getXWithOffset(midSize,midSize), this.getYWithOffset(4), this.getZWithOffset(midSize,midSize), Blocks.mob_spawner, 2);
                TileEntity tileentity = worldIn.getTileEntity(this.getXWithOffset(midSize,midSize), this.getYWithOffset(4), this.getZWithOffset(midSize,midSize));

                if (tileentity instanceof TileEntityMobSpawner)
                {
                    ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setEntityName("Blaze");
                    ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setSpawnCount(1);
                    ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setActivatingRangeFromPlayer(4);
                    ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setMaxSpawnRange(4);
                    ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setLimitedUses(true, (short) 1);
                    ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setBreakOnExhaustion(true);
                }
            }
