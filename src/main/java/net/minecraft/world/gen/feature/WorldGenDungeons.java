...
public class WorldGenDungeons extends WorldGenerator
{
    ...
    private static final String[] SPAWNERTYPES = new String[] {"Skeleton", "Skeleton", "Zombie", "Zombie", "Zombie", "Zombie", "Spider", "Spider", "Creeper"};;
                ...
                for (int j4 = 0; j4 < 3; ++j4)
                {
                    ...
                    if (worldIn.isAirBlock(blockpos2))
                    {
                        ...
                        if (j3 == 1)
                        {
                            ...
                            List<WeightedRandomChestContent> list = WeightedRandomChestContent.func_177629_a(LootTableList.LootOverworld.DUNGEON, new WeightedRandomChestContent[] {Items.enchanted_book.getRandom(rand)});
